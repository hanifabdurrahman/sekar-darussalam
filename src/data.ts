...
export const PROJECT_INFO = {
  ...
  type: "Tipe 36/72",
  whatsappNumber: "62818274185",
  adminName: "Teguh Kuwato",
};
...
export const BENEFITS: Benefit[] = [
  {
    ...
    description:
      "Tumbuh bersama keluarga muslim yang memiliki kesamaan nilai spiritual, saling menjaga, dan menumbuhkan lingkungan sosial yang baik.",
    iconName: "Users",
  },
  {
    id: "b2",
    title: "Rumah Tahfidz",
    description:
      "Pusat belajar Al-Qur’an terintegrasi untuk mendidik karakter moral generasi Robbani sedari dini langsung di kawasan hunian.",
    iconName: "BookOpen",
  },
  {
    id: "b3",
    ...
    description:
      "Infrastruktur jalan utama yang lebar dan asri untuk kenyamanan berkendara serta tata lingkungan yang tertata rapi.",
    iconName: "MapPin",
  },
  {
    id: "b4",
    ...
    description:
      "Skema pembiayaan murni syariah bekerja sama dengan Bank Syariah Nasional, tanpa denda keterlambatan, tanpa sita, dan tanpa riba.",
...
export const DETAILED_REASONS = [
  {
    ...
    description:
      "Keberadaan Rumah Tahfidz di kompleks perumahan membantu pembentukan karakter anak sejak usia dini.",
    badge: "Keluarga Berkarakter",
  },
  {
    title: "Legalitas Clear & Aman",
    description:
      "PBG/IMB induk serta pemecahan sertifikat (SHM) berstatus beres sempurna dan dapat diverifikasi langsung.",
    badge: "Legalitas Clear",
  },
  {
    title: "Arsitektur Islami Nyaman",
    description:
      "Desain minimalis modern dengan sirkulasi udara optimal demi menjaga kenyamanan serta privasi keluarga.",
...
export const TAHFIDZ_BENEFITS = {
  ...
  description:
    "Kami menghadirkan program pembelajaran Al-Qur’an tepat di tengah kawasan hunian untuk mendampingi adab dan akhlak anak setiap hari.",
  points: [
    {
...
export const NEARBY_FACILITIES: NearbyFacility[] = [
  {
    name: "Mushola Thoriqul Jannah (Dalam Kompleks)",
    distance: "0 Meter",
    category: "mosque",
    minutes: 1,
  },
  ...
  {
    name: "Pondok Pesantren Tahfidzul Qur’an",
    distance: "2.5 km",
    category: "education",
    minutes: 6,
  },
  ...
  {
    name: "Klinik Pratama & Bersalin 24 Jam",
    distance: "1.8 km",
    category: "healthcare",
    minutes: 4,
  },
  {
    name: "Pasar Tradisional Wedi Klaten",
    distance: "3.0 km",
    category: "shopping",
    minutes: 7,
  },
  {
    name: "Swalayan & Alun-Alun Kota Klaten",
    distance: "4.5 km",
    category: "shopping",
    minutes: 10,
  },
  {
    name: "Stasiun Kereta Klaten (Akses KRL Jogja-Solo)",
    distance: "4.2 km",
    category: "transport",
    minutes: 10,
  },
...
export const CONSTRUCTION_MILESTONES: ConstructionMilestone[] = [
  {
    ...
    status: "completed",
    description:
      "Lahan lunas tanpa sengketa. Sertifikat (SHM) induk serta perizinan PBG/IMB telah terbit resmi.",
  ...
  },
  {
    ...
    status: "completed",
    description:
      "Pembersihan lahan, perataan (cut & fill), dan pembangunan saluran pembuangan air beton precast.",
    progressPercentage: 100,
  },
  {
    phase: "Tahap 3",
    ...
    status: "in-progress",
    description:
      "Pembangunan pos keamanan, gapura utama kawasan, serta landasan pondasi Mushola internal.",
  ...
  },
  {
    ...
    status: "upcoming",
    description:
      "Pembangunan fisik unit rumah secara bertahap mulai dari struktur pondasi, dinding, hingga rangka atap.",
...
export const PAYMENT_OPTIONS: PaymentOption[] = [
  {
    ...
    description:
      "Opsi terbaik bagi Anda yang memiliki dana siap pakai. Nikmati potongan harga langsung puluhan juta rupiah.",
  ...
  },
  {
    ...
    description:
      "Pembelian unit inden menggunakan KPR Syariah dangan akad pesanan bangun (Istishna') yang aman dan diawasi DSN-MUI.",
  ...
  },
  {
    ...
    description:
      "Angsuran bulanan ringan dicicil langsung ke developer tanpa verifikasi BI checking yang rumit.",
    badge: "Bunga 0%",
    points: [
...
export const LEGALITY_DOCUMENTS: LegalityDocument[] = [
  {
    ...
    description:
      "Lahan berstatus Sertifikat Hak Milik (SHM) murni, aman tanpa sengketa dan siap dibalik nama ke pembeli.",
    isVerified: true,
  },
  {
    ...
    description:
      "Keselarasan tata ruang kawasan terjamin dengan izin PBG/IMB induk yang telah terbit resmi.",
    isVerified: true,
  },
  {
    ...
    statusLabel: "Lengkap",
    description:
      "Verifikasi tata guna lahan kering non-banjir, bebas dari zona hijau pertanian basah.",
    isVerified: true,
  },
  {
    ...
    description:
      "Dikembangkan oleh PT Sekar Mandiri Berkah, berbadan hukum sah dengan akreditasi terpercaya.",
    isVerified: true,
  },
];
...
export const FAQ_ITEMS: FAQItem[] = [
  {
    ...
    answer:
      "Ya, saat ini proyek sedang membangun gapura gerbang utama, pos keamanan, serta landasan pondasi Mushola. Pekerjaan cut-and-fill lahan serta drainase beton precast telah selesai dikerjakan.",
  },
  {
    category: "legal",
    question: "Bagaimana status kepemilikan tanah dan sertifikatnya?",
    answer:
      "Status tanah adalah Sertifikat Hak Milik (SHM). Setiap unit rumah yang diserahterimakan akan mendapatkan SHM pecah kapling dan izin bangunan (PBG/IMB) atas nama pembeli.",
  },
  {
    category: "payment",
    question: "Bagaimana skema pembayaran KPR Bank Syariah?",
    answer:
      "KPR Syariah kami diproses melalui partner Bank Syariah mitra tepercaya menggunakan akad Istishna' (pesanan bangun). Margin bersifat murni flat sehingga angsuran Anda tetap dari awal hingga masa akhir tenor.",
  },
  {
    category: "general",
    question:
      "Apakah diperbolehkan mengubah tata letak ruangan (custom layout)?",
    answer:
